...
while True :
    ...
    val_3 = ADS.readADC(3)
    time.sleep(4)
    print("Analog0:", round(val_0*ads_to_voltage, 3),"V")
    print("Analog1:", round(val_1*ads_to_voltage, 3),"V")
    print("Analog2:", round(val_2*ads_to_voltage, 3),"V")
    print("Analog3:", round(val_3*ads_to_voltage, 3),"V")
    print("...................................")
    print("...................................")