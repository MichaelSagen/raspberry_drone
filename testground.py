...
while True :
    ...
    val_3 = ADS.readADC(3)
    time.sleep(1)
    print("Analog0:", val_0*ads_to_voltage,"V")
    print("Analog1:", val_1*ads_to_voltage,"V")
    print("Analog2:", val_2*ads_to_voltage,"V")
    print("Analog3:", val_3*ads_to_voltage,"V")